...
namespace Org.BouncyCastle.Cms
{
	...
	*/
	public class CmsSignedData
	{
		...
		private readonly ICmsTypedData	signedContent;
		...
		private IDictionary<DerObjectIdentifier, byte[]> hashes;
        ...
        public bool IsDetachedSignature
        {
            get
            {
                return signedData.EncapContentInfo.Content == null && signedData.SignerInfos.Count > 0;
            }
        }
		...
		*/
		...
		public ICmsTypedData SignedContent
		{
		...
		*/
			...
			SignerInformationStore  signerInformationStore)
		{
			...
			foreach (SignerInformation signer in signerInformationStore.GetAll())
			{
