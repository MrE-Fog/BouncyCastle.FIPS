...
namespace Org.BouncyCastle.Cms
{
		...
		: ICmsAttributeTableGenerator
	{
		...
		{
            table = new Dictionary<DerObjectIdentifier, Asn1.Cms.Attribute>();
        }
        ...
        private void DoCreateStandardAttributeTable(IDictionary<string, object> parameters, IDictionary std)
        {
            ...
            {
                Asn1.Cms.Attribute attr = new Asn1.Cms.Attribute(CmsAttributes.CmsAlgorithmProtect, new DerSet(new CmsAlgorithmProtection(
                    (Asn1.X509.AlgorithmIdentifier)parameters[CmsAttributeTableParameter.DigestAlgorithmIdentifier],
                    CmsAlgorithmProtection.Signature, (Asn1.X509.AlgorithmIdentifier)parameters[CmsAttributeTableParameter.SignatureAlgorithmIdentifier])));
                std[attr.AttrType] = attr;
            }
        }
