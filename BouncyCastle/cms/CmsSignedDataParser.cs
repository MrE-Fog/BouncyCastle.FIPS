...
namespace Org.BouncyCastle.Cms
{
	...
	*/
		...
		: CmsContentInfoParser
	{
		...
		private IStore<X509V2AttributeCertificate>				_attributeStore;
		private IStore<X509Certificate>				_certificateStore;
		private IStore<X509Crl>				_crlStore;
			...
			try
			{
				...
				if (octs != null)
				{
					CmsTypedStream ctStr = new CmsTypedStream(
						cont.ContentType, octs.GetOctetStream());
		...
		*/
		public SignerInformationStore GetSignerInfos()
		{
			if (_signerInfoStore == null)
			{
				...
				{
                    hashes[digestKey] = null; // DigestUtilities.DoFinal((IDigest)_digests[digestKey]);
				}
