...
{
    public class DefaultDigestAlgorithmIdentifierFinder : IDigestAlgorithmIdentifierFinder
    {
        private static IDictionary digestOids = Platform.CreateHashtable();
        private static IDictionary digestNameToOids = Platform.CreateHashtable();
