...
namespace Org.BouncyCastle.Crypto.Internal.Encodings
{
    /**
    * this does your basic Pkcs 1 v1.5 padding - whether or not you should be using this
    * depends on your application - see Pkcs1 Version 2 for details.
    */
    internal class Pkcs1Encoding
        : IAsymmetricBlockCipher
    {
         ...
         * </p>
         */
        public static readonly String NOT_STRICT_LENGTH_ENABLED_PROPERTY = "Org.BouncyCastle.Pkcs1.NotStrict";
