...
namespace Org.BouncyCastle.Crypto.Internal.Macs
{
        ...
        : IMac
    {
        ...
        internal GMac(GcmBlockCipher cipher)
            : this(cipher, 128)
        {
        }
        ...
        internal GMac(GcmBlockCipher cipher, int macSizeBits)
        {
            this.cipher = cipher;
        ...
        /// <summary>
        /// Initialises the GMAC - requires a <see cref="Org.BouncyCastle.Crypto.Internal.Parameters.ParametersWithIV"/> 
        /// providing a <see cref="Org.BouncyCastle.Crypto.Internal.Parameters.KeyParameter"/> and a nonce.
        /// </summary>
