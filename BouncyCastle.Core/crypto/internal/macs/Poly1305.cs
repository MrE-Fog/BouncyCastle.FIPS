...
namespace Org.BouncyCastle.Crypto.Internal.Macs
{
        ...
        : IMac
    {
        ...
        private void SetKey(byte[] key, byte[] nonce)
        {
            ...
            k0 = Pack.LE_To_UInt32(kBytes, BLOCK_SIZE + 0);
            k1 = Pack.LE_To_UInt32(kBytes, BLOCK_SIZE + 4);
            k2 = Pack.LE_To_UInt32(kBytes, BLOCK_SIZE + 8);
            k3 = Pack.LE_To_UInt32(kBytes, BLOCK_SIZE + 12);
        }
