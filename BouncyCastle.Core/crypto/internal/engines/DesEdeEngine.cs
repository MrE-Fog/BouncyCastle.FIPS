...
namespace Org.BouncyCastle.Crypto.Internal.Engines
{
    ...
    internal class DesEdeEngine
        : DesEngine
    {
        private static readonly int MAX_BLOCK_COUNT = 1 << 20;
        ...
        */
            ...
            int		outOff)
        {
            ...
            {
                throw new InvalidOperationException("attempt to process more than " + MAX_BLOCK_COUNT + " blocks with TripleDES");
            }
