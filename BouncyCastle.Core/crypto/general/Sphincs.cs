...
using Org.BouncyCastle.Crypto.Internal.Pqc.Crypto;
...
namespace Org.BouncyCastle.Crypto.General
{
    ...
    public class Sphincs
    {
        ...
        /// </summary>
        public static readonly GeneralAlgorithm Alg = new GeneralAlgorithm("Sphincs");

        /// <summary>
        /// Base parameters object for SPHINCS-256 - default is SHA-512.
        /// </summary>
        public static readonly SignatureParameters Sphincs256 = new SignatureParameters(Alg, FipsShs.Sha512);

        public class SignatureParameters : SignatureParameters<SignatureParameters, GeneralAlgorithm, DigestAlgorithm>
        {
            private readonly DigestAlgorithm mTreeDigest;

            internal SignatureParameters(GeneralAlgorithm algorithm, DigestAlgorithm digestAlgorithm) : base(algorithm, digestAlgorithm)
            {
                this.mTreeDigest = null;
            }

            internal override SignatureParameters CreateParameter(GeneralAlgorithm algorithm, DigestAlgorithm digestAlgorithm)
            {
                if (digestAlgorithm != FipsShs.Sha512.Algorithm && digestAlgorithm != FipsShs.Sha3_512.Algorithm)
                {
                    throw new ArgumentException("SPHINCS-256 requires either SHA-512 or SHA3-512");
                }

                return new SignatureParameters(algorithm, digestAlgorithm);
            }

            internal SignatureParameters(SignatureParameters parameters, DigestAlgorithm treeDigest) : base(parameters.Algorithm, parameters.DigestAlgorithm)
            {
                this.mTreeDigest = treeDigest;
            }

            internal DigestAlgorithm TreeDigest
            {
                get { return mTreeDigest; }
            }
        }
        ...
        {
            private readonly DigestAlgorithm treeDigest;

            /// <summary>
            /// Constructor for the default algorithm ID.
            /// </summary>
            public KeyGenerationParameters() : this(FipsShs.Sha512_256)
            {
            }
            ...
            public KeyGenerationParameters(DigestAlgorithm treeDigest) : base(Alg)
            {
        ...
        /// object as the key.
        /// </summary>
		public class KeyPairGenerator : AsymmetricKeyPairGenerator<Parameters<GeneralAlgorithm>, AsymmetricSphincsPublicKey, AsymmetricSphincsPrivateKey>
        {
            private readonly DigestAlgorithm treeDigest;
            private readonly Sphincs256KeyGenerationParameters param;
            private readonly Sphincs256KeyPairGenerator engine = new Sphincs256KeyPairGenerator();
            ...
            {
                this.treeDigest = keyGenParameters.TreeDigestAlgorithm;
                this.param = new Sphincs256KeyGenerationParameters(random, FipsShs.CreateDigest(keyGenParameters.TreeDigestAlgorithm));
            ...
            public override AsymmetricKeyPair<AsymmetricSphincsPublicKey, AsymmetricSphincsPrivateKey> GenerateKeyPair()
            {
                Utils.ApprovedModeCheck("generator", Sphincs.Alg);

                AsymmetricCipherKeyPair kp = engine.GenerateKeyPair();

                SphincsPublicKeyParameters pubKey = (SphincsPublicKeyParameters)kp.Public;
                SphincsPrivateKeyParameters prvKey = (SphincsPrivateKeyParameters)kp.Private;

                Algorithm algorithm = this.Parameters.Algorithm;

                SelfTestExecutor.Validate(algorithm, kp, new KeyPairConsistencyTest(treeDigest));

                return new AsymmetricKeyPair<AsymmetricSphincsPublicKey, AsymmetricSphincsPrivateKey>(new AsymmetricSphincsPublicKey(algorithm, treeDigest, pubKey.GetKeyData()), new AsymmetricSphincsPrivateKey(algorithm, treeDigest, prvKey.GetKeyData()));
            }
        }

        private class KeyPairConsistencyTest : IConsistencyTest<AsymmetricCipherKeyPair>
        {
            private DigestAlgorithm treeDigest;

            internal KeyPairConsistencyTest(DigestAlgorithm treeDigest)
            {
                this.treeDigest = treeDigest;
            }
            ...
            public bool HasTestPassed(AsymmetricCipherKeyPair kp)
            {
                ...
                if (treeDigest == FipsShs.Sha3_256)
                {
                    signer = new Sphincs256Signer(FipsShs.CreateDigest(FipsShs.Sha3_256), FipsShs.CreateDigest(FipsShs.Sha3_512));
                }
                else
                {
                    signer = new Sphincs256Signer(FipsShs.CreateDigest(FipsShs.Sha512_256), FipsShs.CreateDigest(FipsShs.Sha512));
                }
        ...
        private static ICipherParameters GetPublicParameters(AsymmetricSphincsKey key)
        {
            SphincsPublicKeyParameters publicKeyParameters = GetPublicKeyParameters((AsymmetricSphincsPublicKey)key);

            return publicKeyParameters;
        }

        private static ICipherParameters GetPrivateParameters(AsymmetricSphincsKey key)
        {
            SphincsPrivateKeyParameters privateKeyParameters;

            privateKeyParameters = GetPrivateKeyParameters((AsymmetricSphincsPrivateKey)key);
        ...
        internal class SignerProvider : IEngineProvider<ISigner>
        {
            ...
            internal SignerProvider(SignatureParameters parameters, AsymmetricSphincsKey key)
            {
                this.parameters = parameters;
                this.treeAlgorithm = key.TreeDigestAlgorithm;
                if (key is AsymmetricSphincsPublicKey)
                {
            ...
            {
                IMessageSigner sig;
                if (parameters.DigestAlgorithm == FipsShs.Sha512.Algorithm)
                {
                    sig = SelfTestExecutor.Validate(Alg,
                        new Sphincs256Signer(FipsShs.CreateDigest(treeAlgorithm), FipsShs.CreateDigest(FipsShs.Sha512)),
                        new SphincsKatTest(expSha2Pub, expSha2Priv, expSha2Sig));
                }
                else if (parameters.DigestAlgorithm == FipsShs.Sha3_512.Algorithm)
                {
                    sig = SelfTestExecutor.Validate(Alg,
                        new Sphincs256Signer(FipsShs.CreateDigest(treeAlgorithm), FipsShs.CreateDigest(FipsShs.Sha3_512)),
                        new SphincsKatTest(expSha3Pub, expSha3Priv, expSha3Sig));
                }
                else
                {
                    throw new ArgumentException("unknown digest algorithm in SPHINCS-256");
                }

                sig.Init((usage == EngineUsage.SIGNING), sigParams);

                return new SphincsSigner(sig, FipsShs.CreateDigest(parameters.DigestAlgorithm));
            }

            private class SphincsSigner : ISigner
            {
                private readonly IMessageSigner baseSigner;
                private readonly IDigest digest;

                internal SphincsSigner(IMessageSigner baseSigner, IDigest digest)
                {
                ...
                {
                    baseSigner.Init(forSigning, parameters);
                    digest.Reset();
                }
                ...
                public byte[] GenerateSignature()
                {
                    ...
                    return baseSigner.GenerateSignature(message);
                }
                ...
                public bool VerifySignature(byte[] signature)
                {
                    ...
                    return baseSigner.VerifySignature(message, signature);
                }
        ...
        private class SphincsKatTest : VariantKatTest<IMessageSigner>
        {
            private readonly byte[] expSig;
            private readonly byte[] priData;
            private readonly byte[] pubData;

            internal SphincsKatTest(byte[] pubData, byte[] priData, byte[] expSig)
            {
            ...
            internal override void Evaluate(IMessageSigner sphincs256)
            {
                sphincs256.Init(true, new SphincsPrivateKeyParameters(priData));

                byte[] sig = sphincs256.GenerateSignature(msg);

                sphincs256.Init(false, new SphincsPublicKeyParameters(pubData));

                if (!sphincs256.VerifySignature(msg, sig))
                {
                    Fail("signature KAT fails");
                }
            }
        }

        private static SphincsPublicKeyParameters GetPublicKeyParameters(AsymmetricSphincsPublicKey k)
        {
            return new SphincsPublicKeyParameters(k.GetKeyData());
        }

        private static SphincsPrivateKeyParameters GetPrivateKeyParameters(AsymmetricSphincsPrivateKey k)
        {
            return new SphincsPrivateKeyParameters(k.GetKeyData());
        }

        private static readonly byte[] msg = Hex.Decode("64bc21bd5ff42fb29778225d5f770b9393275afe74e5a2afd00efa3848e98d7e0feea3da37d105f21648d9a3df3f39989a2d432d448ac9b7ab9b9a563f64b44f");

        private static readonly byte[] expSha2Pub = Base64.Decode(
        ...
        private static readonly byte[] expSha2Priv = Base64.Decode(
        ...
        private static readonly byte[] expSha2Sig = Base64.Decode(
        ...
        private static readonly byte[] expSha3Pub = Base64.Decode(
            "ICEiIyQlJicoKSorLC0uLzAxMjM0NTY3ODk6Ozw9Pj9AQUJDREVGR0hJSktMTU5PUFFSU1RVVldYWVpbXF1eX2BhYmNkZWZnaGlqa2xtbm9wcXJzdHV2d3h5"
                + "ent8fX5/gIGCg4SFhoeIiYqLjI2Oj5CRkpOUlZaXmJmam5ydnp+goaKjpKWmp6ipqqusra6vsLGys7S1tre4ubq7vL2+v8DBwsPExcbHyMnKy8zNzs/Q0dLT"
                + "1NXW19jZ2tvc3d7f4OHi4+Tl5ufo6err7O3u7/Dx8vP09fb3+Pn6+/z9/v8AAQIDBAUGBwgJCgsMDQ4PEBESExQVFhcYGRobHB0eHyAhIiMkJSYnKCkqKywt"
                + "Li8wMTIzNDU2Nzg5Ojs8PT4/QEFCQ0RFRkdISUpLTE1OT1BRUlNUVVZXWFlaW1xdXl9gYWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXp7fH1+f4CBgoOEhYaH"
        ...
        private static readonly byte[] expSha3Priv = Base64.Decode(
            "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0+P0BBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZ"
                + "WltcXV5fYGFiY2RlZmdoaWprbG1ub3BxcnN0dXZ3eHl6e3x9fn+AgYKDhIWGh4iJiouMjY6PkJGSk5SVlpeYmZqbnJ2en6ChoqOkpaanqKmqq6ytrq+wsbKz"
                + "tLW2t7i5uru8vb6/wMHCw8TFxsfIycrLzM3Oz9DR0tPU1dbX2Nna29zd3t/g4eLj5OXm5+jp6uvs7e7v8PHy8/T19vf4+fr7/P3+/wABAgMEBQYHCAkKCwwN"
                + "Dg8QERITFBUWFxgZGhscHR4fICEiIyQlJicoKSorLC0uLzAxMjM0NTY3ODk6Ozw9Pj9AQUJDREVGR0hJSktMTU5PUFFSU1RVVldYWVpbXF1eX2BhYmNkZWZn"
        ...
        private static readonly byte[] expSha3Sig = Base64.Decode(
